...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="">
        ...
        <a href="<?php echo base_url() . 'Login_controller/logout' ?>" style="color: white; margin-left: 42%;"><i
    ...
    <div class="row" id="body-row">
        <div id="sidebar-container" class="sidebar-expanded d-none d-md-block bg-dark" style="color: #9803fc;">
            <ul class="list-group">
                <li
                    class="list-group-item sidebar-separator-title text-muted d-flex align-items-center menu-collapsed bg-dark">
                    <small>Pilihan</small>
                </li>
                <a href="<?php echo base_url() . 'Index_controller' ?>"
                ...
                <a href="#submenu3" data-toggle="collapse" aria-expanded="false"
                    ...
                    <div class="d-flex w-100 justify-content-start align-items-center" style="margin-left: -5%;">
                        ...
                        <span class="menu-collapsed"><img src=""><b>Persediaan</b></span>
                        <span class="submenu-icon ml-auto"></span>
                    </div>
                </a>
                <div id='submenu3' class="collapse sidebar-submenu">
                    <a href="<?php echo base_url() . 'Laporantransaksi_controller' ?>"
                        class="list-group-item list-group-item-action bg-dark text-white">
                        <span class="fa fa-money-check-alt fa-fw"></span>
                        <span class="menu-collapsed" style="margin-left: 5%;">Stok Product</span>
                    </a>
                </div>
                <?php if ($this->session->userdata('level') == "admin") { ?>
                    ...
                    <div id='submenu4' class="collapse sidebar-submenu">
                        ...
                        <a href="<?php echo base_url() . 'Menu_controller' ?>"
                            class="list-group-item list-group-item-action bg-dark text-white">
