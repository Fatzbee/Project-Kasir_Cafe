    ...
    <table id="datatable" class="table table-striped table-bordered">
      ...
      <tbody>
        <?php foreach ($user as $mn): ?>
              ...
              <center>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="#" data-toggle="modal"
                    data-target="#modal<?php echo $mn->id_user; ?>">Edit</a>
                  <a class="dropdown-item" href="#" data-toggle="modal"
                    data-target="#modalDelete<?php echo $mn->id_user; ?>">Hapus</a>
                  <a class="dropdown-item" href="#" data-toggle="modal"
                    data-target="#modalReset<?php echo $mn->id_user; ?>">Reset Password</a>
                </div>
              </center>
            </td>
          </tr>
          <!-- Modal Delete -->
          <div class="modal fade" id="modalDelete<?php echo $mn->id_user; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="<?= base_url() . 'User_controller/hapusUser/' . $mn->id_user; ?>" id="delete"
          ...
          <div class="modal fade" id="modalReset<?php echo $mn->id_user; ?>" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form-edit" method="POST" action="<?php echo base_url() . 'User_controller/resetPassword' ?>"
                  ...
                  <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="password" id="retype" name="retype" class="form-control" required=""
                        oninvalid="this.setCustomValidity('Re-Type Password Harus Diisi!')"
          ...
          <!-- Modal Edit Menu-->
          <div class="modal fade" id="modal<?php echo $mn->id_user; ?>" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <form class="form-edit" method="POST" action="<?php echo base_url() . 'User_controller/editUser' ?>"
                  enctype="multipart/form-data">
                  <div class="modal-body">
                    <div class="form-group">
                      <input type="hidden" name="id_user" value="<?php echo $mn->id_user; ?>">
                      ...
                      <input id="username" type="text" class="form-control" name="username"
                        value="<?php echo $mn->username; ?>" readonly>
                      ...
                      <select id="level" class="form-control" name="level" required=""
                        oninvalid="this.setCustomValidity('Pilih Salah Satu Level!')"
                        oninput="this.setCustomValidity('')">
...
<div class="modal fade" id="modalTambahUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-tambah" method="POST" action="<?php echo base_url() . 'User_controller/tambahUser' ?>"
        enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <label class="col-form-label">
            ...
            <input id="username" type="text" class="form-control" name="username" required=""
              oninvalid="this.setCustomValidity('Username Harus Diisi!')" oninput="this.setCustomValidity('')">
            ...
            <br>
            <select id="level" class="form-control" name="level" required=""
              oninvalid="this.setCustomValidity('Pilih Salah Satu Level!')" oninput="this.setCustomValidity('')">
            ...
            <br>
            <input type="password" id="retype" class="form-control" name="retype" required=""
              oninvalid="this.setCustomValidity('Re-Type Password Harus Diisi!')" oninput="this.setCustomValidity('')">
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">Submit</button>
