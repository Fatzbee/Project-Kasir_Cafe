  ...
  <div class="container">
    ...
    <div class="card" style="width: 70%; margin: 0% 15% 0% 15%;">
      <div class="card-header bg-primary text-white">
        <center><b>Form Transaksi</b></center>
      </div>
      <div class="card-body">
        <center>
        ...
        <center>
          <button style="width: 20%; margin-top: 2%;" type="button" class="btn btn-primary" data-toggle="modal"
            data-target="#modal">Bayar</button>
        </center>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" class="form-index"
          action="<?php echo base_url() . 'Transaksi_controller/inputPembayaran' ?>">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">
              Type Pembayaran
            </label>
            <br>
            <select id="type" class="btn btn-default" style="height: 100%;  background-color: #ebebeb; width: 25%;"
              name="type" onclick="return cekPembayaran()" required=""
              oninvalid="this.setCustomValidity('Pilih Type Pembayaran!')" oninput="this.setCustomValidity('')">
            ...
            <input type="text" class="form-control" id="customer" name="customer" required=""
              oninvalid="this.setCustomValidity('Customer Harus Diisi!')" oninput="this.setCustomValidity('')">
            ...
            <input type="text" class="form-control" id="no_meja" name="no_meja" required=""
              oninvalid="this.setCustomValidity('Nomor Meja Harus Diisi!')" oninput="this.setCustomValidity('')">
            ...
            <textarea class="form-control" name="uang" id="uang" maxlength="10" style="display: none;" 
              onkeypress="return numeric(event)"></textarea>
            ...
            <center>
              <img src="upload/pembayaran/OVO.jpg" id="ovo" class="card-img-top" alt="..."
